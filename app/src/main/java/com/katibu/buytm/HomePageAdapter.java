...
public class HomePageAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        switch (viewType){
            ...
            case HomePageModel.STRIP_AD_BANNER:
                View stripAdiew = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.strip_ad_layout, viewGroup, false);
                return new StripAdBannerViewholder(stripAdiew);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        switch (homePageModelList.get(position).getType()){
            ...
            case HomePageModel.HORIZONTAL_PRODUCT_VIEW:
                    ...
                    String horozontalLayoutTitle = homePageModelList.get(position).getTitle();
                    List<HorizontalProductScrollModel> horizontalProductScrollModelList = homePageModelList.get(position).getHorizontalProductScrollModelList();
                ((HorizontalProductViewholder)viewHolder).setHorizontalProductLayout(horizontalProductScrollModelList,horozontalLayoutTitle, layoutcolor);
                break;
            case HomePageModel.GRID_PRODUCT_VIEW:
    ...
    public class BannerSliderViewholder extends RecyclerView.ViewHolder{
        ...
        public BannerSliderViewholder(@NonNull View itemView){
            super(itemView);
            bannerSliderViewPager = itemView.findViewById(R.id.banner_slider);
    ...
    public class StripAdBannerViewholder extends RecyclerView.ViewHolder{
        ...
        private void setStripAd(String resource, String color){
            Glide.with(itemView.getContext()).load(resource).apply(new RequestOptions().placeholder(R.drawable.ic_home_black_24dp)).into(stripAdImage);
    ...
    private class HorizontalProductViewholder extends RecyclerView.ViewHolder {
        ...
        public HorizontalProductViewholder(@NonNull View itemView) {
            ...
            horizontalLayoutTitle = itemView.findViewById(R.id.horizontal_scroll_view_title);
            HorizontalviewAllBtn = itemView.findViewById(R.id.horizontal_scroll_view_button);
            horizontalRecycler = itemView.findViewById(R.id.horizontal_scroll_layout_recycler_view);
            horizontalRecycler.setRecycledViewPool(recycledViewPool);
        }
    ...
    public class GridProductViewholder extends RecyclerView.ViewHolder{
        ...
        public GridProductViewholder(@NonNull View itemView){
            ...
            gridLayoutViewAllBtn = itemView.findViewById(R.id.grid_product_btn);
