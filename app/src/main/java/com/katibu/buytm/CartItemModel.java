...
public class CartItemModel {
    ...
    public CartItemModel(int type, int productImage, String productTitle, int freeCoupon, String productPrice, String cuttedPrice, int productQuantity, int offersApplied, int couponApplied) {
        this.type = type;
